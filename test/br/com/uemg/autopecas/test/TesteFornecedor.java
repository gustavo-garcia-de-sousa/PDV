...
public class TesteFornecedor {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try (Connection connection = new ConnectionFactory().getConnection()) {
            ...
            Fornecedor f = new Fornecedor(0, null, "34 9895-3133", "contato@dominio.com.br", "GUSTAVO GARCIA DE SOUSA");

            f.setPessoa(new Pessoa("CNPJ", "32368873000148", "QUEIROZ CONTABILIDADE", "QUEIROZ SERVICOS CONTABEIS, CONSULTORIA E AUDITORIA EIRELI", "01/07/2019", "RUA PRUDENTE DE MORAIS, 316", "CENTRO", "FRUTAL", "MG", "32000-058"));
